...
export default function Dashboard({ onNavigate }: DashboardProps) {
  ...
  return (
    <div className="space-y-6 p-6 bg-cyber-bg min-h-full rounded-2xl border border-cyber-border cyber-grid">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-cyber-header tracking-tighter uppercase font-mono flex items-center gap-2">
              CyberSuite <span className="text-cyber-green">OS</span> Dashboard
            </h1>
            <div className="flex items-center gap-3 text-[10px] font-mono text-cyber-text/60 uppercase">
        ...
        <div className="flex items-center gap-4">
          <div className="px-4 py-2 bg-cyber-card/60 border border-cyber-border rounded-lg flex items-center gap-3 shadow-inner relative overflow-hidden group">
            <div className="absolute inset-0 bg-cyber-green/5 opacity-0 group-hover:opacity-100 transition-opacity" />
            <div className="flex flex-col items-end relative z-10">
              <span className="text-[9px] font-mono text-cyber-text/60 uppercase">System Integrity</span>
              <span className="text-xs font-mono text-cyber-header font-bold tracking-widest">SECURE_v4.2</span>
            </div>
          ...
          <div className="px-4 py-2 bg-cyber-card/60 border border-cyber-border rounded-lg flex items-center gap-3 shadow-inner">
            <div className="flex flex-col items-end">
              <span className="text-[9px] font-mono text-cyber-text/60 uppercase">System Load</span>
              <span className="text-xs font-mono text-cyber-header font-bold">{Math.round(systemLoad)}%</span>
            </div>
            <div className="w-24 h-1.5 bg-cyber-card/10 rounded-full overflow-hidden">
              <motion.div 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <motion.div
            ...
            className="cyber-card p-5 rounded-xl group relative overflow-hidden transition-all hover:border-cyber-border/40"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-cyber-card/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
            ...
            <div className="flex justify-between items-start mb-4">
              <div className={cn("p-2.5 rounded-lg bg-black/40 border border-cyber-border shadow-inner", stat.color)}>
                <stat.icon size={20} />
              </div>
            ...
            <div>
              <p className="text-[10px] font-mono text-cyber-text/60 uppercase tracking-widest mb-1">{stat.label}</p>
              <h3 className="text-3xl font-bold text-cyber-header font-mono tracking-tighter mb-1">{stat.value}</h3>
              <p className="text-[9px] font-mono text-cyber-text/40 uppercase tracking-tight">{stat.desc}</p>
            </div>
          </motion.div>
        ))}
      </div>
        ...
        <div className="cyber-card rounded-xl p-6 flex flex-col">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-mono uppercase tracking-widest text-cyber-header">System Integrity Pulse</h2>
            </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-2">
            <div className="p-2 bg-black/40 border border-cyber-border rounded-lg text-center">
              <div className="text-[9px] font-mono text-cyber-text/60 uppercase">Overall Score</div>
              <div className="text-lg font-bold text-cyber-green font-mono">92.4</div>
            </div>
            <div className="p-2 bg-black/40 border border-cyber-border rounded-lg text-center">
              <div className="text-[9px] font-mono text-cyber-text/60 uppercase">Threat Level</div>
        ...
        <div className="lg:col-span-2 cyber-card rounded-xl p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-mono uppercase tracking-widest text-cyber-header">Attack Surface Trends (24h)</h2>
            </div>
        ...
        <div className="lg:col-span-3 cyber-card rounded-xl p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-mono uppercase tracking-widest text-cyber-header">Real-time Traffic Analysis</h2>
            </div>
            <div className="text-[10px] font-mono text-cyber-text/60 uppercase">Throughput: 1.2 GB/s</div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="md:col-span-3 h-[200px] bg-black/40 rounded-xl border border-cyber-border p-4 relative overflow-hidden">
            ...
            <div className="space-y-4">
              <div className="p-3 bg-cyber-card/5 border border-cyber-border rounded-lg">
                <div className="text-[9px] font-mono text-cyber-text/60 uppercase mb-1">TCP Handshakes</div>
                <div className="text-lg font-bold text-cyber-header">12,432/s</div>
              </div>
              <div className="p-3 bg-cyber-card/5 border border-cyber-border rounded-lg">
                <div className="text-[9px] font-mono text-cyber-text/60 uppercase mb-1">UDP Datagrams</div>
                <div className="text-lg font-bold text-cyber-header">8,102/s</div>
              </div>
              <div className="p-3 bg-cyber-card/5 border border-cyber-border rounded-lg">
                <div className="text-[9px] font-mono text-cyber-text/60 uppercase mb-1">ICMP Echo</div>
                <div className="text-lg font-bold text-cyber-header">452/s</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between px-1">
            <h2 className="text-[10px] font-mono font-bold text-cyber-text/60 uppercase tracking-[0.2em] flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              >
                <div className={cn("p-2 rounded-lg bg-black/40 group-hover:bg-cyber-card/10 transition-all", tool.color)}>
                  <tool.icon size={18} />
                </div>
                <span className="text-[9px] font-mono font-bold text-cyber-text/60 uppercase tracking-wider group-hover:text-cyber-header transition-colors">
                  {tool.name}
                </span>
              </motion.button>
            ))}
          ...
          <div className="cyber-card p-4 rounded-xl bg-gradient-to-br from-cyber-green/5 to-transparent border-cyber-green/10">
            ...
            <p className="text-[10px] font-mono text-cyber-text/60 leading-relaxed italic">
        ...
        <div className="lg:col-span-3 cyber-card rounded-xl overflow-hidden flex flex-col">
          ...
          <div className="p-4 border-b border-cyber-border bg-cyber-card/40 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-mono uppercase tracking-widest text-cyber-header">Neural Threat Topology</h2>
            </div>
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-cyber-green rounded-full shadow-[0_0_8px_#00ff41]" />
                <span className="text-[9px] font-mono text-cyber-text/60 uppercase">Active Nodes</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse shadow-[0_0_8px_#ef4444]" />
                <span className="text-[9px] font-mono text-cyber-text/60 uppercase">Incursions</span>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 cyber-card rounded-xl overflow-hidden flex flex-col">
          <div className="p-4 border-b border-cyber-border bg-cyber-card/40 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-mono uppercase tracking-widest text-cyber-header">SIEM Event Stream</h2>
              </div>
              <div className="flex items-center gap-2 border-l border-cyber-border pl-4">
                <select 
                  value={filter}
                  onChange={(e) => setFilter(e.target.value)}
                  className="bg-black/60 border border-cyber-border text-[9px] font-mono text-cyber-text/60 px-2 py-1 rounded outline-none focus:border-cyber-green transition-colors"
                >
          ...
          <div className="overflow-x-auto flex-1 max-h-[350px] custom-scrollbar">
            <table className="w-full text-left text-[10px] font-mono whitespace-nowrap">
              <thead className="sticky top-0 bg-cyber-bg z-10 border-b border-cyber-border">
                <tr className="text-cyber-text/60 uppercase">
                ...
                <AnimatePresence initial={false}>
                  {logs
                    ...
                    <motion.tr 
                      ...
                      className="border-b border-cyber-border hover:bg-cyber-card/5 transition-colors cursor-pointer group"
                    >
                      <td className="p-4 text-cyber-text/40">{log.time}</td>
                      <td className="p-4 font-bold text-cyber-header group-hover:text-cyber-green transition-colors truncate max-w-[200px]">{log.event}</td>
                      ...
                      <td className="p-4 text-cyber-text/60">{log.protocol || 'N/A'}</td>
                      <td className="p-4">
                        <span className="px-1.5 py-0.5 rounded bg-cyber-card/5 border border-cyber-border text-[8px] text-cyber-text/60">
                          {log.geo || 'N/A'}
                        </span>
                      </td>
                      <td className="p-4">
                        <span className="px-2 py-0.5 rounded bg-cyber-card/5 border border-cyber-border text-[8px] text-cyber-text/60">
                          {log.status}
                        </span>
                      </td>
                      <td className="p-4">
        ...
        <div className="cyber-card rounded-xl flex flex-col">
              ...
              <div className="space-y-4">
                {[1, 2, 3].map(i => (
                  <div key={i} className="animate-pulse space-y-2">
                    <div className="h-3 bg-cyber-card/5 rounded w-3/4" />
                    <div className="h-2 bg-cyber-card/5 rounded w-full" />
                    <div className="h-2 bg-cyber-card/5 rounded w-1/2" />
                  </div>
                ))}
              </div>
            ) : (
              <AnimatePresence mode="popLayout">
                {(liveFeed.length > 0 ? liveFeed : threatNews).map((news, i) => (
                  <motion.div
                    ...
                    className="p-3 bg-cyber-card/5 border border-cyber-border rounded-lg hover:border-red-500/30 transition-all group cursor-pointer"
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-[8px] font-mono text-cyber-text/40">{news.timestamp}</span>
                    </div>
                    <h3 className="text-[11px] font-bold text-cyber-header mb-1 group-hover:text-red-400 transition-colors line-clamp-1">{news.title}</h3>
                    <p className="text-[10px] text-cyber-text/60 leading-relaxed mb-2 line-clamp-2">{news.summary}</p>
                    <div className="flex items-center justify-between text-[8px] font-mono text-cyber-text/40">
          ...
          <div className="p-3 border-t border-cyber-border bg-black/40 text-[9px] font-mono text-cyber-text/40 flex justify-between">
            ...
            >
              ...
              <div className="p-8 space-y-6">
                <div className="space-y-2">
                  <div className="text-[10px] font-mono text-cyber-text/60 uppercase tracking-widest">Event Signature</div>
                  <div className="text-xl font-bold text-cyber-header tracking-tight">{selectedLog.event}</div>
                </div>
                
                <div className="grid grid-cols-2 gap-4 p-4 bg-cyber-card/5 border border-cyber-border rounded-xl">
                  <div className="space-y-1">
                    <div className="text-[10px] font-mono text-cyber-text/60 uppercase">Source Vector</div>
                    <div className="text-xs font-mono text-blue-400 font-bold">{selectedLog.source} {selectedLog.geo && <span className="text-cyber-text/60">[{selectedLog.geo}]</span>}</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-[10px] font-mono text-cyber-text/60 uppercase">Target Vector</div>
                  ...
                  <div className="space-y-1">
                    <div className="text-[10px] font-mono text-cyber-text/60 uppercase">Protocol</div>
                    <div className="text-xs font-mono text-cyber-text">{selectedLog.protocol || 'N/A'}</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-[10px] font-mono text-cyber-text/60 uppercase">MITRE Tactic</div>
                    <div className="text-xs font-mono text-cyber-text">{selectedLog.mitreTactic || 'N/A'}</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-[10px] font-mono text-cyber-text/60 uppercase">MITRE Technique</div>
                    <div className="text-xs font-mono text-cyber-text">{selectedLog.mitreTechnique || 'N/A'}</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-[10px] font-mono text-cyber-text/60 uppercase">Status</div>
                    <div className="text-xs font-mono text-emerald-500 uppercase font-bold">{selectedLog.status}</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-[10px] font-mono text-cyber-text/60 uppercase">Risk Level</div>
                    ...
                    )}>{selectedLog.severity} {selectedLog.confidence && <span className="text-cyber-text/60">({selectedLog.confidence}% conf)</span>}</div>
                  </div>
                </div>

                <div className="space-y-2">
                  <div className="text-[10px] font-mono text-cyber-text/60 uppercase tracking-widest">Forensic Summary</div>
                  <div className="p-4 bg-black/40 border border-cyber-border rounded-xl text-xs text-cyber-text/60 leading-relaxed font-mono">
